...
from .elktools import readElkfiles as read_Elk
from .elktools import ElkConverterTools as Elk_tools

class Converter(ConverterTools,Elk_tools,read_Elk):
    """
...
#                ar[self.bc_subgrp][it] = locals()[it]
    ...
    def convert_transport_input(self):
        ...
        from .elktools import getpmatelk
