...
#endif
{
  ...
  if (itt.shape()[0] != NUM_TET_CORNERS + 1) { NDA_RUNTIME_ERROR << "  The first dimension of 'itt' must be equal to 5"; }
  ...
  for (it = 0; it < ntet; it++) {
    ...
    for (i = 0; i < 4; i++) { cti(inds[i], it) = ci[i]; }
  ...
  switch (flag) {
    ...
    case 2:
      if (std::abs(e4 - e2) > tol && std::abs(e3 - e2) > tol && std::abs(e4 - e1) > tol && std::abs(e3 - e1) > tol)
        *ct = 3.0 * ((e3 - en) * (en - e2) / ((e4 - e2) * (e3 - e2) * (e3 - e1)) + (e4 - en) * (en - e1) / ((e4 - e1) * (e4 - e2) * (e3 - e1)));
      else {
        ...
        *ct = 3.0
           * std::real(((e3 - en + s) * (en - e2 + s) / ((e4 - e2 + s) * (e3 - e2 + s) * (e3 - e1 + s))
...
static void fun_dos_case1(double en, double *eigs, double *ci) {
  ...
  ci[0] = K2(en, e1, e2, e4) * F(en, e2, e1, e1, e3) + K2(en, e1, e2, e3) * F(en, e3, e1, e1, e4) + K2(en, e1, e3, e4) * F(en, e4, e1, e1, e2);
...
static void fun_dos_case2(double en, double *eigs, double *ci) {
  ...
  ci[0] = 0.5
     * (K1(en, e3, e1) * (F(en, e3, e2, e2, e4) + F(en, e4, e1, e2, e4) + F(en, e3, e1, e2, e4))
        + K1(en, e4, e1) * (F(en, e4, e1, e2, e3) + F(en, e4, e2, e2, e3) + F(en, e3, e1, e2, e3)));

  ci[1] = 0.5
     * (K1(en, e3, e2) * (F(en, e3, e2, e1, e4) + F(en, e4, e2, e1, e4) + F(en, e3, e1, e1, e4))
        + K1(en, e4, e2) * (F(en, e3, e2, e1, e3) + F(en, e4, e1, e1, e3) + F(en, e4, e2, e1, e3)));

  ci[2] = 0.5
     * (-K1(en, e2, e3) * (F(en, e3, e2, e1, e4) + F(en, e4, e2, e1, e4) + F(en, e3, e1, e1, e4))
        - K1(en, e1, e3) * (F(en, e3, e2, e2, e4) + F(en, e4, e1, e2, e4) + F(en, e3, e1, e2, e4)));

  ci[3] = 0.5
     * (-K1(en, e2, e4) * (F(en, e3, e2, e1, e3) + F(en, e4, e1, e1, e3) + F(en, e4, e2, e1, e3))
        - K1(en, e1, e4) * (F(en, e4, e1, e2, e3) + F(en, e4, e2, e2, e3) + F(en, e3, e1, e2, e3)));
}
...
static void fun_dos_case3(double en, double *eigs, double *ci) {
  ...
  ci[3] = -K2(en, e4, e3, e1) * F(en, e4, e3, e2, e4) - K2(en, e4, e2, e3) * F(en, e4, e2, e1, e4) - K2(en, e4, e1, e2) * F(en, e4, e1, e3, e4);
}
